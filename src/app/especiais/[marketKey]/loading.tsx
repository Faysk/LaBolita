export default function SpecialMarketLoading() {
  return (
    <main className="page-container min-w-0 overflow-hidden py-7 md:py-10" aria-label="Carregando palpite final">
      <div className="mb-7">
        <div className="skeleton h-4 w-36 rounded-xl" />
        <div className="skeleton mt-3 h-12 w-80 max-w-full rounded-2xl" />
      </div>

      <section className="card-dark min-w-0 overflow-hidden rounded-[2rem] p-4 md:p-6 lg:p-7">
      ...
      <section className="mt-7 grid min-w-0 items-start gap-5 lg:grid-cols-[1.25fr_0.95fr]">
